...
def campaign_view(
    ...
    if stalemated:
        ...
        def add_chunks(name_orig, lines,el):
        ...
        el=add_chunks("Automatons", automaton_list,el)
        el=add_chunks("Terminids", terminids_list,el)
        el=add_chunks("Illuminate", illuminate_list,el)
        el=add_chunks("Other", other_list,el)
